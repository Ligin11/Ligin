  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      ...
      <div >
        ...
        <p className='my-6 text-[15px] text-gray-500'>Effortlessly remove image backgrounds with AI-powered precision. <br className='max-sm:hidden'/> Upload your image and get a clean, transparent result in seconds!</p>
        <div>
