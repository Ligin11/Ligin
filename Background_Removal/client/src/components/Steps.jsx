  ...
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-20'>
      ...
      <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
        <div className='flex items-start gap-4 bg-white border-sm drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
            <img className='max-w-9' src={assets.upload_icon} alt="" />
            <div>
                <p className='text-xl font-medium'>Upload image</p>
                <p className='text-sm text-neutral-500 mt-1'>You can upload the image here  and <br/> remove the background</p>
            </div>
        </div>
        <div className='flex items-start gap-4 bg-white border-sm drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
